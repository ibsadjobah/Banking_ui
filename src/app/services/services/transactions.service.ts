...
export class TransactionsService extends BaseService {
  ...
  static readonly Save1Path = '/api/v1/transactions/add';
  ...
  static readonly FindAll1Path = '/api/v1/transactions';
  ...
  static readonly FindById1Path = '/api/v1/transactions/{transactionId}';
  ...
  static readonly Delete1Path = '/api/v1/transactions/{transactionId}';
  ...
  static readonly FindAllByUserIdPath = '/api/v1/transactions/user/{userId}';
