...
import { delete4 } from '../fn/accounts/delete-4';
import { Delete4$Params } from '../fn/accounts/delete-4';
import { findAll4 } from '../fn/accounts/find-all-4';
import { FindAll4$Params } from '../fn/accounts/find-all-4';
import { findById4 } from '../fn/accounts/find-by-id-4';
import { FindById4$Params } from '../fn/accounts/find-by-id-4';
import { save4 } from '../fn/accounts/save-4';
import { Save4$Params } from '../fn/accounts/save-4';
...
export class AccountsService extends BaseService {
  ...
  static readonly Save4Path = '/api/v1/accounts';
  ...
  static readonly FindById4Path = '/api/v1/accounts/{accountId}';
  ...
  static readonly Delete4Path = '/api/v1/accounts/{accountId}';
