...
import { inValidateAccount } from '../fn/user/in-validate-account';
import { InValidateAccount$Params } from '../fn/user/in-validate-account';
...
export class UserService extends BaseService {
  ...
  static readonly ValidateAccountPath = '/api/v1/users/validate/{userId}';
  ...
  static readonly InValidateAccountPath = '/api/v1/users/invalidate/{userId}';
