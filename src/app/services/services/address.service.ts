...
export class AddressService extends BaseService {
  ...
  static readonly FindAll3Path = '/api/v1/addresses';
  ...
  static readonly Save3Path = '/api/v1/addresses';
  ...
  static readonly FindById3Path = '/api/v1/addresses/{addressId}';
  ...
  static readonly Delete3Path = '/api/v1/addresses/{addressId}';
